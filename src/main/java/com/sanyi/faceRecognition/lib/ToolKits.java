package com.sanyi.faceRecognition.lib;
...
import com.sanyi.faceRecognition.common.ErrorCode;
import com.sanyi.faceRecognition.service.Data;
import com.sanyi.faceRecognition.common.PaintPanel;
...
//
	...
	public static String getErrorCodePrint() {
		return "\n{error code: (0x80000000|" + (Data.netsdk.CLIENT_GetLastError() & 0x7fffffff) +").参考  NetSDKLib.java }"
				+ " - {error info:" + ErrorCode.getErrorCode(Data.netsdk.CLIENT_GetLastError()) + "}\n";
	}
